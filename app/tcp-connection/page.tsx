...
Transmitted message: 10110011010
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4">6. TCP Connection Management</h2>

      <p className="mb-4">TCP uses a three-way handshake to establish a connection and a four-way handshake to terminate it.</p>
      
      <h2 className="text-2xl font-semibold mt-8 mb-4">6.1 Three-way Handshake (Connection Establishment)</h2>
      <ol className="list-decimal pl-6 mb-4">
        <li>Client sends SYN packet (Sequence Number: X)</li>
        <li>Server responds with SYN-ACK packet (Sequence Number: Y, Acknowledgment Number: X+1)</li>
        <li>Client sends ACK packet (Acknowledgment Number: Y+1)</li>
      </ol>
      
      <h2 className="text-2xl font-semibold mt-8 mb-4">6.2 Four-way Handshake (Connection Termination)</h2>
      <ol className="list-decimal pl-6 mb-4">
        <li>Client sends FIN packet</li>
        <li>Server sends ACK packet</li>
        <li>Server sends FIN packet</li>
        <li>Client sends ACK packet</li>
      </ol>
      
      <h2 className="text-2xl font-semibold mt-8 mb-4">6.3 TCP State Transition Diagram</h2>
      <p className="mb-4">The TCP state transition diagram illustrates the various states a TCP connection can be in during its lifecycle.</p>
